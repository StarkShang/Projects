...
namespace Corrector.Core
{
    ...
    public class Cell
    {
        ...
        private Builder compiler = new Builder();
        ...
        public static Cell CellCreator(string id) {
            var directory = new DirectoryInfo(Path.Combine(ConfigInfo.CellPath.FullName, id));
            return directory.Exists ? new Cell() { Root = directory } : null;
        }
    }
}
