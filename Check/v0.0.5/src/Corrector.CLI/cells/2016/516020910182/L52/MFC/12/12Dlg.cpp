...
BEGIN_MESSAGE_MAP(CMy12Dlg, CDialogEx)
	...
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_BN_CLICKED(IDC_BUTTON1, &CMy12Dlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CMy12Dlg::OnMouseMove(UINT nFlags, CPoint point)
{
...
void CMy12Dlg::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	m_StartDraw=false;
...
void CMy12Dlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	CWnd *pCanvasWnd = GetDlgItem(IDC_CANVAS);
	CDC *pCanvasDC = pCanvasWnd->GetDC();
