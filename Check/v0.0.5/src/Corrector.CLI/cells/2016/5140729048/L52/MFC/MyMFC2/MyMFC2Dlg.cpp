...
CMyMFC2Dlg::CMyMFC2Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMyMFC2Dlg::IDD, pParent)
	, m_StartDraw(false)
	, m_PrevPoint(0)
	, m_ShiftPoint(0)
{
...
void CMyMFC2Dlg::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void CMyMFC2Dlg::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	m_StartDraw=false;
...
void CMyMFC2Dlg::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if(m_StartDraw)
	{
