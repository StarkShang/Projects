...
CMy04Dlg::CMy04Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMy04Dlg::IDD, pParent)
	, m_StartDraw(false)
	, m_PrevPoint(0)
	, m_ShiftPoint(0)
{
...
void CMy04Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMy04Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMy04Dlg::OnBnClickedButton1)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
END_MESSAGE_MAP()
...
void CMy04Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMy04Dlg::OnQueryDragIcon()
{
...
void CMy04Dlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	CWnd *pCanvasWnd = GetDlgItem(IDC_CANVAS);
...
void CMy04Dlg::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void CMy04Dlg::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	m_StartDraw = false;
...
void CMy04Dlg::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if(m_StartDraw)
	{
