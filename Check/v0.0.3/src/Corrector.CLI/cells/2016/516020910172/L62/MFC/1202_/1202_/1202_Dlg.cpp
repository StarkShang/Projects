...
CMy1202_Dlg::CMy1202_Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMy1202_Dlg::IDD, pParent)
{
...
void CMy1202_Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMy1202_Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
	ON_BN_CLICKED(IDC_BUTTON1, &CMy1202_Dlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CMy1202_Dlg::OnBnClickedButton2)
END_MESSAGE_MAP()


// CMy1202_Dlg 消息处理程序

BOOL CMy1202_Dlg::OnInitDialog()
{
...
void CMy1202_Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMy1202_Dlg::OnQueryDragIcon()
{
...
void CMy1202_Dlg::InitCanvas(void)
{
	//设置并更换画刷
...
void CMy1202_Dlg::UpdateBox(int rowIndex, int colIndex)
{
	//创建红绿两种画刷
...
void CMy1202_Dlg::UpdateBall(int rowMove, int colMove)
{
	if(m_StartGame)
	{
		//更新小球位置
...
void CMy1202_Dlg::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void CMy1202_Dlg::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	//关闭开始绘制的开关
	m_StartDraw=false;
...
void CMy1202_Dlg::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	//计算当前鼠标所在的方格并更新方格
	...
	void CMy1202_Dlg::OnBnClickedButton1()
	{
		// TODO: 在此添加控件通知处理程序代码
		//设置并更换画刷
	...
	void CMy1202_Dlg::OnBnClickedButton2()
	{
		// TODO: 在此添加控件通知处理程序代码
		//调用initcanvas函数初始化游戏
		InitCanvas();
	...
	BOOL CMy1202_Dlg::PreTranslateMessage(MSG* pMsg)
	{
