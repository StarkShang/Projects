...
void CMy3Dlg::UpdateBox(int rowIndex, int colIndex)
{
	//创建红绿两种画刷
...
void CMy3Dlg::UpdateBall(int rowMove, int colMove)
{
	if (m_StartGame) {
		//更新小球位置
...
void CMy3Dlg::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	//关闭开始绘制开关
	m_StartDraw=false;
...
void CMy3Dlg::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	//计算当前鼠标所在的方格并更新方格
