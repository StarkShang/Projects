...
void CMFCApplication1Dlg::InitCanvas()
{
	//设置并更换画刷
...
void CMFCApplication1Dlg::UpdateBox(int rowIndex, int colIndex)
{
	//创建红绿两种画刷
...
void CMFCApplication1Dlg::UpdateBall(int rowMove, int colMove)
{
	if (m_StartGame)
	{
		//更新小球位置
